...
1.It turns the character after it into a string character instead of something the JS compiler is keying off of

2. Create a line break in the console

3.Allows us to keep the "'"
